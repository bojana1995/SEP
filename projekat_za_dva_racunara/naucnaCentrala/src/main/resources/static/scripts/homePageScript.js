$(document).ready(function(){
				$.ajax({
					url : "https://192.168.43.196:9081/korisnik/dekriptovanjeEmailAdrese",
					crossDomain: true,
				...
				$.ajax({
					url : "https://192.168.43.196:9081/korisnik/getTrenutnoAktivan",
					type: "GET",
					crossDomain: true,
			        headers: {  'Access-Control-Allow-Origin': '*' },
			        xhrFields: {
			...
			$("#dugmeOdjaviSe").click(function(){
				localStorage.clear();
				$.ajax({
					url: "https://192.168.43.196:9081/korisnik/odjava",
					type: "POST",
					data: null,
					contentType: "application/json",
					datatype: 'json',
			...
			/*$.ajax({
				...
				if(data.uloga=="UREDNIK" || data.uloga=="GLAVNI_UREDNIK"){
					$.ajax({
						url: "https://192.168.43.196:9081/korisnik/getNaucneOblastiKojePokrivaUrednik",
						type: "GET",
						contentType: "application/json",
						datatype: 'json',
						crossDomain: true,
			 ...
			 function azurirajCasopis(id){
				 ...
				 $.ajax({
					url: "https://192.168.43.196:9081/casopis/" + id,
					type: "GET",
					contentType: "application/json",
					datatype: 'json',
					crossDomain: true,
				...
				$("#dugmeAzurirajCasopisModalni").click(function(){
					...
					if(provera) {
						...
						$.ajax({
							url: "https://192.168.43.196:9081/casopis/azuriraj/" + id,
							type: "PUT",
							data: formData,
							contentType: "application/json",
							datatype: 'json',
			 ...
			 function obrisiCasopis(id){
				$.ajax({	
					url: "https://192.168.43.196:9081/casopis/obrisi/" + id,
					type: "DELETE",
					contentType: "application/json",
					datatype: 'json',
					crossDomain: true,
			 ...
			 function azurirajNaucnuOblast(id){
					...
					$.ajax({
						url: "https://192.168.43.196:9081/naucnaOblast/" + id,
						type: "GET",
						contentType: "application/json",
						datatype: 'json',
						crossDomain: true,
					...
					$("#dugmeAzurirajNaucnuOblastModalni").click(function(){
						...
						if(provera) {
							...
							$.ajax({
								url: "https://192.168.43.196:9081/naucnaOblast/azuriraj/" + id,
								type: "PUT",
								data: formData,
								contentType: "application/json",
								datatype: 'json',
				 ...
				 function obrisiNaucnuOblast(id){
					$.ajax({	
						url: "https://192.168.43.196:9081/naucnaOblast/obrisi/" + id,
						type: "DELETE",
						contentType: "application/json",
						datatype: 'json',
						crossDomain: true,
				 ...
				 function azurirajRad(id){
						...
						$.ajax({
							url: "https://192.168.43.196:9081/rad/" + id,
							type: "GET",
							contentType: "application/json",
							datatype: 'json',
							crossDomain: true,
						...
						$("#dugmeAzurirajRadModalni").click(function(){
							...
							if(provera) {
								...
								$.ajax({
									url: "https://192.168.43.196:9081/rad/azuriraj/" + id,
									type: "PUT",
									data: formData,
									contentType: "application/json",
									datatype: 'json',
					 ...
					 function obrisiRad(id){
						...
						$.ajax({	
							url: "https://192.168.43.196:9081/rad/obrisi/" + id,
							type: "DELETE",
							contentType: "application/json",
							datatype: 'json',
							crossDomain: true,
				...
				function azurirajKorisnickePodatke(){
					...
					$("#dugmeAzurirajKorisnickePodatkeModalni").click(function(){
						...
						if(provera) {
							...
							$.ajax({
								url: "https://192.168.43.196:9081/korisnik/azurirajKorisnika",
								type: "PUT",
								data: formData,
								contentType: "application/json",
								datatype: 'json',
					 ...
					 function kupiCasopis(merchant_id, amount, merchant_password) {
						var data = JSON.stringify({
							...
							$.ajax({
								async: false,
								url: "https://192.168.43.196:5522/zahtev/"+path,
						        type: "POST",
						        contentType: "application/json",
						        data: data,
						        dataType: "text",
						        ...
						        /*success: function (data) {
						        	window.location.href="https://192.168.43.196:9081/banka.html?paymentId="+data.paymentId;	
						        },*/
						...
						function paypalPretplata(merchant_id,paypalId, paypalSecret, amount) {
							...
							$.ajax({
								async: false,
								url: "https://192.168.43.196:5522/zahtev/pretplata",
						        type: "POST",
						        contentType: "application/json",
						        data: data,
						        dataType: "text",
							...
							$.ajax({
						        ...
						        success: function (data) {
						        	...
						        	var trans = JSON.stringify({
						        		"tipPlacanja" : "bitcoin",
						        		"uspesnost" : "uspesno",
						        		"paymentId" : splitovan[1],
						        		"merchant_order_id" : splitovan[2]
						        	});
						        	//alert('podaciZaTransakciju:\n' + podaciZaTransakciju);
						        	debugger;
						        	$.ajax({
										async: false,
										url: "https://192.168.43.196:5522/zahtev/sacuvajTransakciju",
								        type: "POST",
								        contentType: "application/json",
								        data: trans,
								        dataType: "json",
...
function dodajUKorpu(id){
	...
	if(dugmeValue==="Dodaj u korpu"){
		...
		$.ajax({
			async: false,
			url: "https://192.168.43.196:9081/korpa/add/" + id,
	        type: "POST",
	        crossDomain: true,
	        headers: {  'Access-Control-Allow-Origin': '*' },
	        success: function () {
		...
		$.ajax({
			async: false,
			url: "https://192.168.43.196:9081/korpa/delete/" + id,
	        type: "POST",
	        crossDomain: true,
	        headers: {  'Access-Control-Allow-Origin': '*' },
	        success: function () {
